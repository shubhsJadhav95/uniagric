...
export default function FarmerLoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!userDoc.exists() || userDoc.data().userType !== 'farmer') {
        // Update user type to farmer if not already
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      // Pass 'farmer' as the userType parameter to automatically set this user as a farmer
      const user = await signInWithGoogle('farmer');
